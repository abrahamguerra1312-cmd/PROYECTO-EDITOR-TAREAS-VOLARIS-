...
with st.sidebar:
    ...
    **Características:**
    ...
    remove_metadata = st.checkbox(
        ...
        value=True,
        help="Elimina páginas con solo números, tablas vacías, etc."
    )
...
with st.expander("📖 Ejemplo de uso"):
    st.markdown("""
    **Archivo de entrada:** `N513VL.pdf`
    **Archivo de salida:** `N513VL F.pdf`
    
    **Mejoras aplicadas:**
    - Eliminación de hojas de control
...
# Footer
st.divider()
st.caption("Volaris PDF Processor | Powered by Streamlit")